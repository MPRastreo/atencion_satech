...
const Content = ({ content }: PageProps<{ content: any }>) => {
                                            ...
                                            (content.length > 0) ?
                                                ...
                                                (
                                                    <Card className='w-full'>
                                                        <CardHeader>
                                                            <CardTitle>{element.title ?? 'No disponible'}</CardTitle>
                                                            <CardDescription>{element.description ?? 'No disponible'}</CardDescription>
                                                        </CardHeader>
                                                        <CardContent>
