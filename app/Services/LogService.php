...
class LogService
{
    private const logUrl = "https://log.wsmprastreo.com.mx/api/v1/log";
    ...
    private const projectName = "Atención SATECH";
    private const customerName = "SATECH Rastreo Satelital";
